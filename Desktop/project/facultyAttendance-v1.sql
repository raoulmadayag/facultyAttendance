...
CREATE TABLE `faculty_attendance` (
  ...
  KEY `code_idx` (`code`),
  CONSTRAINT `code` FOREIGN KEY (`code`) REFERENCES `faculty_sched` (`code`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `faculty_info` (
  ...
  CONSTRAINT `dept_id` FOREIGN KEY (`dept_id`) REFERENCES `faculty_dept` (`dept_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `faculty_sched` (
  ...
  CONSTRAINT `faculty_id` FOREIGN KEY (`faculty_id`) REFERENCES `faculty_info` (`faculty_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-05 14:20:43
